...
| **The Silent-Accept Hunter** | 3-compiler differential fuzzer proves the hole is a bug class: **22/45 cases silently accept wrong code** on stock tsgo across every covariant container, with boundary (≥120) and immune families (fn-args, unions, readonly) mapped | Journal XV |
